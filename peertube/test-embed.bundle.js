...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/standalone/videos/test-embed.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/jschannel/src/jschannel.js":
/*!*************************************************!*\
  !*** ./node_modules/jschannel/src/jschannel.js ***!
  \*************************************************/
...
/***/ "./src/standalone/player/events.ts":
/*!*****************************************!*\
  !*** ./src/standalone/player/events.ts ***!
  \*****************************************/
/*! exports provided: EventRegistrar */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventRegistrar", function() { return EventRegistrar; });
...
/***/ "./src/standalone/player/player.ts":
/*!*****************************************!*\
  !*** ./src/standalone/player/player.ts ***!
  \*****************************************/
/*! exports provided: PeerTubePlayer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PeerTubePlayer", function() { return PeerTubePlayer; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var jschannel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jschannel */ "./node_modules/jschannel/src/jschannel.js");
/* harmony import */ var jschannel__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jschannel__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./events */ "./src/standalone/player/events.ts");
...
class PeerTubePlayer {
    ...
    constructor(embedElement, scope) {
        ...
        this.scope = scope;
        this.eventRegistrar = new _events__WEBPACK_IMPORTED_MODULE_2__["EventRegistrar"]();
    ...
    constructChannel() {
        this.channel = jschannel__WEBPACK_IMPORTED_MODULE_1__["build"]({
...
/***/ "./src/standalone/videos/test-embed.scss":
/*!***********************************************!*\
  !*** ./src/standalone/videos/test-embed.scss ***!
  \***********************************************/
/*! no exports provided */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _test_embed_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./test-embed.scss */ "./src/standalone/videos/test-embed.scss");
/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../player/player */ "./src/standalone/player/player.ts");



window.addEventListener('load', () => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function* () {
    ...
    const player = new _player_player__WEBPACK_IMPORTED_MODULE_2__["PeerTubePlayer"](document.querySelector('iframe'));
    ...
    monitoredEvents.forEach(e => {
        player.addEventListener(e, (param) => console.log(`PLAYER: event '${e}' received`, param));
    ...
    let playbackRates = [];
    let currentRate = yield player.getPlaybackRate();
    const updateRates = () => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function* () {
    ...
    const updateCaptions = () => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function* () {
        const captions = yield player.getCaptions();
    ...
    updateCaptions();
    const updateResolutions = ((resolutions) => {
    ...
    player.getResolutions().then(resolutions => updateResolutions(resolutions));
